    ...
    if model_basename is not None:
        if ".ggml" in model_basename:
            ...
            model_path = hf_hub_download(
                repo_id=model_id, filename=model_basename, local_dir='./models', resume_download=True)
            # model_path = ""
            max_ctx_size = 2048
            kwargs = {
...
def main(device_type, show_sources):
    ...
    2. Loads the existing vectorstore that was created by ingest.py
    ...
    while True:
        ...
        if not show_sources:  # this is a flag that you can set to disable showing answers.
